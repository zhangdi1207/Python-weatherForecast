                ...
                if len(needText.split('阵风'))==2:
                    ...
                    for needSplit in needText.split('阵风'):
                        ...
                        if gustData != '':
                            gustData+='阵风'
                        pattern1=re.compile(p1)
                        tempNeedSplit=pattern1.findall(needSplit)
                    ...
                    #print(555,tempWindData)
                    tempNeedSplit=firstWind.split('转')
                    #print(8888,tempNeedSplit)
                    if len(tempNeedSplit)==1:
                        ...
                        tempWindData=pattern1.findall(tempNeedSplit[0])
                        if len(tempWindData)==1:
                            tempD[1]+=tempWindData[0]
                        else:
                            tempD[1] +=tempWindData[0]+'-'+tempWindData[1]
                        tempD[1]+=' to '
                        tempWindData=pattern1.findall(tempNeedSplit[1])
                        if len(tempWindData)==1:
                            tempD[1]+=tempWindData[0]
                        else:
                            tempD[1] +=tempWindData[0]+'-'+tempWindData[1]
                    #print(777,tempD[1],tempNeedSplit)
                    p1="\d{1,2}"
                    pattern1=re.compile(p1)
...
def mailData(landData,seaData,t):
    ...
    if t!= None:
        ...
        for ser,mydate in enumerate(['01','02','03']):
            ...
            if landData[ser][3]==None:
                landData[ser][3]=landData[ser][4]
            ...
            temp=landData[ser][6]
            if len(landData[ser])==7:
                landData[ser].append(landData[ser][6])
            ...
            #print(111111,('9' in str(seaData[ser][0])) or ('10' in str(seaData[ser][0])) or ('11' in str(seaData[ser][0])) or ('12' in str(seaData[ser][0])))
            #print(222222,'8' in str(seaData[ser][0]))
            #print(33333,seaData[ser][0],'backgroundColor04'+mydate)
...
def getMailData():
    ...
    <td style="BORDER-BOTTOM: black 1pt solid; BORDER-LEFT: windowtext 1pt solid; BACKGROUND-COLOR: backgroundColor0102; WIDTH: 46pt; BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 1pt solid" class="xl99" rowspan="2" width="61">
    ...
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: #f0f0f0; BACKGROUND-COLOR: backgroundColor0302; WIDTH: 136pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl70" width="181">
    <p align="center"><font size="2" face="Times New Roman">　</font></p>
    </td>
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: #f0f0f0; BACKGROUND-COLOR:backgroundColor0402; WIDTH: 178pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl81" width="237">
    <p align="center"><font size="2" face="Times New Roman">　</font></p>
    </td>
    </tr>
    <tr style="HEIGHT: 18pt; mso-height-source: userset" height="24">
    ...
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: windowtext; BACKGROUND-COLOR: backgroundColor0302; WIDTH: 136pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl86" width="181">
    <p align="center"><font size="2"><font face="Times New Roman">myData0602</font></font></p>
    </td>
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: windowtext; BACKGROUND-COLOR: backgroundColor0402; WIDTH: 178pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl82" width="237">
    ...
    <td style="BORDER-BOTTOM: black 1pt solid; BORDER-LEFT: windowtext 1pt solid; BACKGROUND-COLOR: backgroundColor0202; WIDTH: 46pt; BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 1pt solid" class="xl99" rowspan="2" width="61">
    ...
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: windowtext; BACKGROUND-COLOR: backgroundColor0302; WIDTH: 136pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl73" width="181">
    ...
    <td style="BORDER-BOTTOM: windowtext 1pt solid; BORDER-LEFT: #f0f0f0; BACKGROUND-COLOR: backgroundColor0302; WIDTH: 136pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl69" width="181">
    <p align="center"><font size="2" face="Times New Roman">　</font></p>
    </td>
    <td style="BORDER-BOTTOM: windowtext 1pt solid; BORDER-LEFT: #f0f0f0; BACKGROUND-COLOR: backgroundColor0402; WIDTH: 178pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl83" width="237">
    <p align="center"><font size="2" face="Times New Roman">　</font></p>
    </td>
    </tr>
    <tr style="HEIGHT: 18pt; mso-height-source: userset" height="24">
    ...
    <td style="BORDER-BOTTOM: black 1pt solid; BORDER-LEFT: windowtext 1pt solid; BACKGROUND-COLOR: backgroundColor0103; WIDTH: 46pt; BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 1pt solid" class="xl99" rowspan="2" width="61">
    ...
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: #f0f0f0; BACKGROUND-COLOR: backgroundColor0303; WIDTH: 136pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl70" width="181">
    <p align="center"><font size="2" face="Times New Roman">　</font></p>
    </td>
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: #f0f0f0; BACKGROUND-COLOR: backgroundColor0403; WIDTH: 178pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl81" width="237">
    <p align="center"><font size="2" face="Times New Roman">　</font></p>
    </td>
    </tr>
    <tr style="HEIGHT: 18pt; mso-height-source: userset" height="24">
    ...
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: windowtext; BACKGROUND-COLOR: backgroundColor0303; WIDTH: 136pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl86" width="181">
    <p align="center"><font size="2"><font face="Times New Roman">myData0603</font></font></p>
    </td>
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: windowtext; BACKGROUND-COLOR: backgroundColor0403; WIDTH: 178pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl82" width="237">
    ...
    <td style="BORDER-BOTTOM: black 1pt solid; BORDER-LEFT: windowtext 1pt solid; BACKGROUND-COLOR: backgroundColor0203; WIDTH: 46pt; BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 1pt solid" class="xl99" rowspan="2" width="61">
    ...
    <td style="BORDER-BOTTOM: #f0f0f0; BORDER-LEFT: windowtext; BACKGROUND-COLOR: backgroundColor0303; WIDTH: 136pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl73" width="181">
    ...
    <td style="BORDER-BOTTOM: windowtext 1pt solid; BORDER-LEFT: #f0f0f0; BACKGROUND-COLOR: backgroundColor0303; WIDTH: 136pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl69" width="181">
    <p align="center"><font size="2" face="Times New Roman">　</font></p>
    </td>
    <td style="BORDER-BOTTOM: windowtext 1pt solid; BORDER-LEFT: #f0f0f0; BACKGROUND-COLOR: backgroundColor0403; WIDTH: 178pt; BORDER-TOP: #f0f0f0; BORDER-RIGHT: windowtext 1pt solid" class="xl83" width="237">
    <p align="center"><font size="2" face="Times New Roman">　</font></p>
    </td>
    </tr>
    <tr style="HEIGHT: 13.5pt; mso-height-source: userset" height="18">
